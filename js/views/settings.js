...
export function renderSettings() {
  ...
  show({
    ...
    node: h(
      ...
      h('p', { class: 'muted small' }, '「未確認」は、作者が内容を確かめる前の下書きです。クイズとフラッシュカードには、この設定に関係なく確認済みの項目だけが出題されます。'),
    ...
    node: h(
      ...
      sec(
        ...
        ul(
          ...
          '「未確認」のバッジが付いた項目は、作者が内容を確かめる前の下書きです。はじめは表示しない設定になっています（設定の「未確認項目の表示」で切り替えられます）。',
